  ...
  public:
   ...
   void print( ostream_type & ofs )
    ...
    uv_type hi = { lo[0]+ m_board[0] * m_square, lo[1] + m_board[1] * m_square };
     ...
     {
      std::string board = std::to_string( hi[0]-lo[0]  ) + "x" + std::to_string( hi[1]-lo[1]  ) + "mm";
      auto x = lo[0] + 0.1*(hi[0]-lo[0]);
      auto y = lo[1] - m_av[0].size()[1] + 7.5+12 + 5 + 5;
      ofs <<"  <g  transform=\"translate(" << x <<" " << y << ") scale( 1 )\">" << std::endl; text( ofs, board, "#a0a0a0", 5 ); ofs <<"    </g>" << std::endl;
     }
     {
      std::string board = std::to_string( int( m_av[0].size()[0]) ) + "x" + std::to_string( int( m_av[0].size()[1] ) ) + "mm";
      auto x = lo[0] + 0.1*(hi[0]-lo[0]);
      auto y = lo[1] - m_av[0].size()[1] + 7.5+12 + 5 + 5 + 5;
      ofs <<"  <g  transform=\"translate(" << x <<" " << y << ") scale( 1 )\">" << std::endl; text( ofs, board, "#a0a0a0", 5 ); ofs <<"    </g>" << std::endl;
     }
...
void main()
 {
  ...
  lineA3( "A3-gray002.svg", { 0, 0, 0}, { 256.0/( 1* 2 ), 256.0/( 1* 2 ), 256.0/( 1* 2 ) }, { 1,  2 }, { 0b0000101001101111111001011,0b0000101001101111110001010,0b0000101001101001110110110,0b0000101001101001011100111} );
  lineA3( "A3-gray008.svg", { 0, 0, 0}, { 256.0/( 2* 4 ), 256.0/( 2* 4 ), 256.0/( 2* 4 ) }, { 2,  4 }, { 0b0000101001101111110001010,0b0000101001101001110110110,0b0000101001101001011100111,0b0000101001100111111001011} );
  lineA3( "A3-gray032.svg", { 0, 0, 0}, { 256.0/( 4* 8 ), 256.0/( 4* 8 ), 256.0/( 4* 8 ) }, { 4,  8 }, { 0b0000101001101001110110110,0b0000101001101001011100111,0b0000101001100111111001011,0b0000101001100111110001010} );
  lineA3( "A3-gray128.svg", { 0, 0, 0}, { 256.0/( 8*16 ), 256.0/( 8*16 ), 256.0/( 8*16 ) }, { 8, 16 }, { 0b0000101001101001011100111,0b0000101001100111111001011,0b0000101001100111110001010,0b0000101001100001110110110} );
  lineA3( "A3-gray006.svg", { 0, 0, 0}, { 256.0/( 2* 3 ), 256.0/( 2* 3 ), 256.0/( 2* 3 ) }, { 2,  3 }, { 0b0000101001100111111001011,0b0000101001100111110001010,0b0000101001100001110110110,0b0000101001100001011100111} );
  lineA3( "A3-gray024.svg", { 0, 0, 0}, { 256.0/( 4* 6 ), 256.0/( 4* 6 ), 256.0/( 4* 6 ) }, { 4,  6 }, { 0b0000101001100111110001010,0b0000101001100001110110110,0b0000101001100001011100111,0b0000101001011111101001111} );
  lineA3( "A3-gray096.svg", { 0, 0, 0}, { 256.0/( 8*12 ), 256.0/( 8*12 ), 256.0/( 8*12 ) }, { 8, 12 }, { 0b0000101001100001110110110,0b0000101001100001011100111,0b0000101001011111101001111,0b0000101001011111100001110} );
